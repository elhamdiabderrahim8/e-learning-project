            ...
            <form class="register-form" action="../backend/actions/register.php" method="post">
                <div class="input-row">
                    <div class="input-group">
                        ...
                        <input type="text" id="firstname" name="CIN" placeholder="13456722" autocomplete="CIN" required>
                        <label for="firstname">Prenom</label>
                        <input type="text" id="firstname" name="nom" placeholder="Jean" autocomplete="given-name" required>
                    </div>
                    <div class="input-group">
                        <label for="lastname">Nom</label>
                        <input type="text" id="lastname" name="prenom" placeholder="Dupont" autocomplete="family-name" required>
                    </div>
                </div>

...
function lang_text($fr, $en)
{
    return current_language() === 'en' ? (string) $en : (string) $fr;
}

function app_translation_map()
{
    static $map = null;
    ...
    $map = [
        ...
        'Mon Profil' => 'My Profile',
        'Mettre à jour mes informations' => 'Update my information',
        'Prénom' => 'First name',
        ...
        'Voulez-vous vraiment supprimer votre photo de profil ?' => 'Do you really want to delete your profile picture?',
...
function translate_output_by_language($content)
{
    $content = (string) $content;

    $forward = app_translation_map();
    if (current_language() === 'en') {
        return strtr($content, $forward);
    }

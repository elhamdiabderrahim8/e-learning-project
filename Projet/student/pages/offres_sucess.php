...
<body>
                ...
                ?>
                        <div class="course-card">
                            ...
                            <div class="course-body">
                                ...
                                <p>Par <?php echo htmlspecialchars($row['nom_prof'] . " " . $row['prenom_prof']); ?></p>
                                
                                <div class="price-tag">
                                    <?php echo number_format((float)$row['prix'], 2); ?> DT
                                </div>
                                
                                <button type="button" class="btn-primary" onclick="ouvrirModalPaiement(<?php echo $row['id_cours']; ?>)" style="width:100%;">
                                    Payer
                                </button>
                            </div>
                        </div>
    ...
    <div id="modal-paiement-global" class="modal-overlay">
        <div class="modal-content">
            ...
            <form action="../backend/actions/traiter_paiement.php" method="POST">

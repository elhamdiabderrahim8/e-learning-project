        ...
        <main class="main-content">
            <header class="header header-flex">
                ...
                <div class="header-actions">
                    <a class="btn-nav" href="lesson.php?id=<?php echo $courseId; ?>">Retour aux leçons</a>
                </div>
            </header>
            ...
            <script>
                function markLessonDone() {
                    ...
                    fetch('../backend/actions/valider_lesson.php', {
                        ...
                        .then(function () { window.location.href = 'lesson.php?id=' + idCours; })
                        .catch(function () { window.location.href = 'lesson.php?id=' + idCours; });
                }

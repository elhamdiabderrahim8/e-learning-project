...
// Les colonnes paiement_valide et payment_status_note ont été migrées vers le schéma principal.
...
<body>
    ...
    <div id="card-modal" class="modal-overlay" style="display:none;">
        <div class="modal-content" style="max-width:460px;">
            ...
            <form method="POST" action="../backend/actions/traiter_paiement.php">

...
#support-fab {
    ...
    width:56px; height:56px; background:#4f46e5; border-radius:50%; border:none;
    cursor:pointer; box-shadow:0 4px 16px rgba(79,70,229,.4);
    display:flex; align-items:center; justify-content:center; transition:.2s;
}
#support-fab:hover { background:#4338ca; transform:scale(1.08); }
...
.sp-msg.user  { background:#eef2ff; align-self:flex-end; }

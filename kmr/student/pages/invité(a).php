        ...
        <header class="topbar guest-topbar" aria-label="Navigation invite">
            <div class="container topbar-inner guest-topbar-inner">
                <a class="brand" href="../index.php" aria-label="Retour a l'accueil etudiant">
                    ...
                    <span>Enjah Invite</span>
                </a>

                <nav class="nav-links guest-nav" aria-label="Navigation rapide invite">
                    <a href="#hero">Decouverte</a>
                    <a href="#infos">Avantages</a>
                    <a href="#catalogue">Cours gratuits</a>
                </nav>

                <div class="top-actions guest-top-actions">
                    <a href="login.php" class="btn btn-ghost">Connexion</a>
                    <a href="registre.php" class="btn btn-primary">Inscription</a>
                    <a href="../index.php" class="btn btn-soft">Accueil</a>
                </div>
            </div>
        </header>

        <main class="main-content guest-main">
            <section class="header guest-hero" id="hero">
            ...
            <section class="guest-info-grid" id="infos">
            ...
            <section class="header guest-catalog-header" id="catalogue">
                <div>
                        ...
                        <article class="course-card guest-course-card" id="cours-<?php echo (int) $row['id']; ?>">
                            ...
                            <div class="course-body guest-course-body">
                                ...
                                <div class="guest-course-actions">
                                    <a href="lesson(a).php?id=<?php echo (int) $row['id']; ?>" class="btn-primary">Consulter les lecons</a>
